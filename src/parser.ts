...
export const EXECUTION_TYPES: Record<StatementType, ExecutionType> = {
  ...
  SHOW_BINARY: 'INFORMATION',
  SHOW_BINLOG: 'INFORMATION',
  SHOW_CHARACTER: 'INFORMATION',
  SHOW_COLLATION: 'INFORMATION',
  SHOW_CREATE: 'INFORMATION',
  SHOW_ENGINE: 'INFORMATION',
  SHOW_ENGINES: 'INFORMATION',
  SHOW_ERRORS: 'INFORMATION',
  SHOW_EVENTS: 'INFORMATION',
  SHOW_FUNCTION: 'INFORMATION',
  SHOW_GRANTS: 'INFORMATION',
  SHOW_MASTER: 'INFORMATION',
  SHOW_OPEN: 'INFORMATION',
  SHOW_PLUGINS: 'INFORMATION',
  SHOW_PRIVILEGES: 'INFORMATION',
  SHOW_PROCEDURE: 'INFORMATION',
  SHOW_PROCESSLIST: 'INFORMATION',
  SHOW_PROFILE: 'INFORMATION',
  SHOW_PROFILES: 'INFORMATION',
  SHOW_RELAYLOG: 'INFORMATION',
  SHOW_REPLICAS: 'INFORMATION',
  SHOW_SLAVE: 'INFORMATION',
  SHOW_REPLICA: 'INFORMATION',
  SHOW_STATUS: 'INFORMATION',
  SHOW_TRIGGERS: 'INFORMATION',
  SHOW_VARIABLES: 'INFORMATION',
  SHOW_WARNINGS: 'INFORMATION',
  SHOW_DATABASES: 'INFORMATION',
  SHOW_KEYS: 'INFORMATION',
  SHOW_INDEX: 'INFORMATION',
  SHOW_TABLE: 'INFORMATION', // for SHOW TABLE STATUS
  SHOW_TABLES: 'INFORMATION',
  SHOW_COLUMNS: 'INFORMATION',
